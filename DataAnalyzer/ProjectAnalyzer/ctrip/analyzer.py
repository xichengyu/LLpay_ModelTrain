...
import sys
sys.path.append("../../../ModelBuilder/BaseModule")
...
birth_city = sorted(Counter(raw_data["籍贯"]).items(), key=lambda d: d[1], reverse=True)

xtick = [birth_city[i][0] for i in range(15)]
name = [x for x in range(15)]
num = [birth_city[i][1] for i in range(15)]

print(xtick)
print(name)
print(num)

dv.BarChart(name, num, "BirthCity")
